  ...
  return (
    <div>
      ...
      <MyDialog open={open} setOpen={setOpen} title="Community Ritual">
        <div className="p-10 py-8 space-y-8">
          <div>
            <p className="text-TitleSmall2">Purpose</p>
            <p className="text-BodyMedium2 text-black">
              We will share a fascinating information article, which will get
              you thinking about the current state of AI
            </p>
          </div>
          <div>
            <p className="text-TitleSmall2">Who is it for ? </p>
            <p className="text-BodyMedium2 text-black">
              We will share a fascinating information article, which will get
              you thinking about the current state of AI
            </p>
          ...
          <div>
            <p className="text-TitleSmall2">Rules</p>
            <ol>
              {[
                ...
                <li key={key} className="flex items-center space-x-4 space-y-2">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                  ...
                  <p className="text-BodyMedium2 text-black">{rule}</p>
                </li>
              ))}
            </ol>
          </div>
...
export default DialogCommunityRules;
