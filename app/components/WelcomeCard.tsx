  ...
  return (
    <div className="max-w-xl space-y-4">
      ...
      <div className="space-y-2">
        ...
        <button className="flex items-center space-x-2 bg-green px-12 py-6 rounded-[4rem] border text-BodyLarge hover:rounded-3xl hover:opacity-75 transition-all duration-300">
