        ...
        <div className="flex flex-col justify-between h-full">
          <div className="flex flex-col flex-1 space-y-3">
            <div className="flex justify-between">
              ...
              <div className="h-2.5 bg-slate-300 rounded-full w-12 opacity-40"></div>
            </div>
            <div className="h-4 bg-slate-200 rounded-full w-full"></div>
            <div className="h-4 bg-slate-200 rounded-full w-48 md:w-72"></div>
            ...
            <div className="h-2.5 bg-slate-300 rounded-full w-52 opacity-40"></div>

            {/* comments skeleton */}
            {[1, 2].map((_, key) => (
              <div
                key={key}
                className="flex justify-between space-x-4 items-center pt-4"
              >
                <div className="flex flex-1">
                  <svg
                    className="w-10 h-10 me-3 text-slate-300"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 20"
            ...
            <div className="flex items-center justify-center space-x-2 py-4">
              <div className="w-32 md:w-48 bg-slate-200 h-2.5 rounded-full"></div>
              <svg
                width="11"
                height="7"
                viewBox="0 0 11 7"
          ...
          <div className="border border-slate-300 h-[56px] rounded-full"></div>
        </div>
      </LoadingSkeleton>
    </Box>
  );
