...
import PublishShare from "@/components/discussion/PublishShare";
      ...
      <div className="bg-brown h-full">
        <Container className="md:h-[calc(100vh-5rem)] overflow-y-scroll">
          <div className="space-y-4">
            ...
            <PublishShare
              shareData={{
                title: discussion.title || "Discussion title example",
                text: "Small discussion description here!",
                url: `${process.env.NEXT_PUBLIC_PRODUCTION_URL}/discussion/${params.id}`,
              }}
              variant="discussion"
            />
